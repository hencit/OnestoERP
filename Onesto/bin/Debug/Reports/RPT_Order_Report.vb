...
Public Class RPT_Order_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Onesto.RPT_Order_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Order_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Order_Report = New RPT_Order_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
