...
Public Class RPT_Order_Form
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Onesto.RPT_Order_Form.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_detail_id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Order_Form
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Order_Form = New RPT_Order_Form()
        rpt.Site = Me.Site
        Return rpt
    End Function
