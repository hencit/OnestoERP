...
Public Class frmPOS
    ...
    Private Sub txtTotalAddDiscPerc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtTotalAddDiscPerc.KeyPress
        If Asc(e.KeyChar) <> 8 Then
            If Asc(e.KeyChar) < 48 Or Asc(e.KeyChar) > 57 Then
                e.Handled = True
            End If
    ...
    Private Sub txtTotalAddDiscPerc_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtTotalAddDiscPerc.LostFocus
        Try
            If txtTotalAddDiscPerc.Text = "" Then

            Else
                txtTotalAddDisc.Text = CStr(CDec(txtTotalGross.Text) * CInt(txtTotalAddDiscPerc.Text) / 100)
            End If
            saveHeader()
            view_record()
        Catch ex As Exception
            txtTotalAddDiscPerc.Text = "0"
        End Try
    End Sub
