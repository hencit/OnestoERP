...
Public Class fdlOrder
    ...
    Private Sub fdlOrder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Sub clear_lvw()
        Try
            ...
            With ListView1
                ...
                .Columns.Add("Receipt", 0)
                .Columns.Add("Total", 0, HorizontalAlignment.Right)
                .Columns.Add("Dibuat Oleh", 100)
            End With
