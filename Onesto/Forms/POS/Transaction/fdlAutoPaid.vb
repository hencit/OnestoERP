...
Public Class fdlAutoPaid
    Private ListView1Sorter As lvColumnSorter
    Dim strConnection As String = My.Settings.ConnStr
    Dim cn As SqlConnection = New SqlConnection(strConnection)
    Dim cmd As SqlCommand
    Dim m_FrmCallerId As String = "frmPOS"
    ...
    Private Sub fdlAutoPaid_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Sub clear_lvw()
        Try
            ...
            With ListView1
                ...
                .Columns.Add("Receipt", IIf(m_FrmCallerId = "frmPOS", 100, 0))
                .Columns.Add("Total", IIf(m_FrmCallerId = "frmPOS", 120, 0), HorizontalAlignment.Right)
