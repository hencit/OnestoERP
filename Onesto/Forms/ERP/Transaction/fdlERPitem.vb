...
Public Class fdlERPitem
    ...
    Private Sub fdlERPitem_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Sub clear_lvw()
        With ListView1
            .Clear()
            .View = View.Details
            .Columns.Add("Kode", 150)
            .Columns.Add("Nama", 200)
            .Columns.Add("Kategori", 0)
            .Columns.Add("Satuan", 80)
        End With

        cmd = New SqlCommand("sp_mt_item_SEL", cn)
        cmd.CommandType = CommandType.StoredProcedure

        Dim prm1 As SqlParameter = cmd.Parameters.Add("@item_name", SqlDbType.NVarChar, 50)
